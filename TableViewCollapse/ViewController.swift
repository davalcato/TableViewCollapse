...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ExpandableHeaderViewDelegate {
    ...
    var sections = [
        ...
        Section(genre: "Superhero", movies: ["Guardians of the Galaxy", "The Flash", "The Avengers", "The Dark Knight"], expanded: false),
        Section(genre: "Horror", movies: ["The Walking Dead", "Insidious", "Conjuring"], expanded: false)
